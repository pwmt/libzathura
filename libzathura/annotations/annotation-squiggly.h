...
#ifndef LIBZATHURA_ANNOTATION_SQUIGGLY_H
#define LIBZATHURA_ANNOTATION_SQUIGGLY_H
 ...
 */
zathura_error_t zathura_annotation_squiggly_set_quad_points(zathura_annotation_t* annotation, zathura_list_t* quad_points);
