...
#ifndef LIBZATHURA_ANNOTATION_HIGHLIGHT_H
#define LIBZATHURA_ANNOTATION_HIGHLIGHT_H
 ...
 */
zathura_error_t zathura_annotation_highlight_set_quad_points(zathura_annotation_t* annotation, zathura_list_t* quad_points);
 ...
 * @return ZATHURA_ERROR_UNKNOWN An unspecified error occurred
 */
zathura_error_t zathura_annotation_highlight_get_quad_points(zathura_annotation_t* annotation, zathura_list_t** quad_points);

#ifdef __cplusplus
}
#endif

#endif //ANNOTATION_HIGHLIGHT_H
