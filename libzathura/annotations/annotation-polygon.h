...
#ifndef LIBZATHURA_ANNOTATION_POLYGON_H
#define LIBZATHURA_ANNOTATION_POLYGON_H
 ...
 */
zathura_error_t zathura_annotation_polygon_set_vertices(zathura_annotation_t* annotation, zathura_list_t* vertices);
 ...
 * @return ZATHURA_ERROR_UNKNOWN An unspecified error occurred
 */
zathura_error_t zathura_annotation_polygon_set_interior_color(zathura_annotation_t*
    annotation, zathura_annotation_color_t interior_color);

/**
 * Returns the interior color of the polygon annotation with which to fill the
 * annotation’s line endings.
 *
 * @param[in] annotation The annotation
 ...
 * @return ZATHURA_ERROR_UNKNOWN An unspecified error occurred
 */
zathura_error_t zathura_annotation_polygon_get_interior_color(zathura_annotation_t*
    annotation, zathura_annotation_color_t* interior_color);

/**
 * Sets the intent of this polygon annotation
 *
 * @param[in] annotation The annotation
 ...
 * @return ZATHURA_ERROR_UNKNOWN An unspecified error occurred
 */
zathura_error_t zathura_annotation_polygon_set_intent(zathura_annotation_t*
    annotation, zathura_annotation_markup_intent_t intent);

/**
 * Returns the intent of this polygon annotation
 *
 * @param[in] annotation The annotation
 ...
 * @return ZATHURA_ERROR_UNKNOWN An unspecified error occurred
 */
zathura_error_t zathura_annotation_polygon_get_intent(zathura_annotation_t*
    annotation, zathura_annotation_markup_intent_t* intent);

/**
 * Sets the measure dictionary of this polygon annotation
 *
 * @param[in] annotation The annotation
 ...
 * @return ZATHURA_ERROR_UNKNOWN An unspecified error occurred
 */
zathura_error_t zathura_annotation_polygon_set_measure(zathura_annotation_t*
    annotation, zathura_annotation_measure_t* measure);

/**
 * Returns the measure dictionary of this polygon annotation
 *
 * @param[in] annotation The annotation
