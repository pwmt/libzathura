...
zathura_error_t
zathura_annotation_highlight_set_quad_points(zathura_annotation_t* annotation,
...
zathura_error_t
zathura_annotation_highlight_get_quad_points(zathura_annotation_t* annotation,
    zathura_list_t** quad_points)
{
