...
zathura_error_t zathura_page_search_text(zathura_page_t* page, const char* text, girara_list_t** results);
zathura_error_t zathura_page_get_text(zathura_page_t* page, zathura_rectangle_t rectangle, char** text);
zathura_error_t zathura_page_get_links(zathura_page_t* page, girara_list_t** links);
zathura_error_t zathura_page_get_form_fields(zathura_page_t* page, girara_list_t** form_fields);
zathura_error_t zathura_page_get_images(zathura_page_t* page, girara_list_t** images);
