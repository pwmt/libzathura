...
START_TEST(test_form_field_get_type) {
  ...
  /* valid arguments */
  zathura_form_field_t* form_field2;
  TEST_FORM_FIELD_GET_TYPE(page, form_field2, type, ZATHURA_FORM_FIELD_BUTTON)
  TEST_FORM_FIELD_GET_TYPE(page, form_field2, type, ZATHURA_FORM_FIELD_TEXT)
  TEST_FORM_FIELD_GET_TYPE(page, form_field2, type, ZATHURA_FORM_FIELD_CHOICE)
  TEST_FORM_FIELD_GET_TYPE(page, form_field2, type, ZATHURA_FORM_FIELD_SIGNATURE)
} END_TEST
